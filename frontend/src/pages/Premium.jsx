...
const Premium = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-white pt-5 md:pt-20 pb-4">
      <Helmet>
        <title>Premium | Nesiatv</title>
        <meta
          name="description"
          content="Upgrade ke Nesiatv Premium untuk membaca lebih nyaman tanpa iklan, bonus point tambahan, dan auto scroll manga."
        />
      </Helmet>
            ...
            <form onSubmit={handleSubmitOrder} className="p-5 space-y-4">
              <div className="rounded-xl border border-dashed border-amber-300 dark:border-amber-500/30 p-3 bg-amber-50/50 dark:bg-amber-500/5">
                <p className="text-sm text-amber-700 dark:text-amber-300">
                  Transfer ke QRIS Nesiatv, lalu upload bukti transfer Anda di bawah ini.
                </p>
                <div className="mt-3">
                  <img
                    src={qrisImage}
