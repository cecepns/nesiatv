...
const Library = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-transparent text-gray-900 dark:text-gray-100">
      <Helmet>
        <title>Library | Nesiatv</title>
        <meta
          name="description"
          content="Bookmark, readlist, dan riwayat nonton anime di Nesiatv. Kelola koleksi favoritmu dengan mudah."
        />
      </Helmet>
                ...
                <div>
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Anime yang kamu simpan (tersimpan per akun)
                    </p>
                  </div>
                  {bookmarkLoading ? (
                    ...
                    <div className="text-center py-12 bg-gray-100 dark:bg-white/[0.04] dark:border dark:border-white/10 rounded-lg">
                      ...
                      <p className="text-gray-400 dark:text-gray-500 text-sm">
                        Buka detail anime dan simpan ke bookmark untuk melihat
                        di sini
                      </p>
                    </div>
                  ) : (
                                ...
                                <div className="absolute top-2 right-2">
                                  <button
                                    ...
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      apiClient
                                        .removeReadlistItem(readlistDetail.id, item.anime_id)
          ...
          {activeTabId === "popular" && (
            <div>
              <div className="mb-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Top 50 anime populer per kategori
                </p>
              </div>
                  ...
                  {mangaPickerResults.map((m) => {
                    const alreadyIn =
                      ...
                      readlistDetail.items.some(
                        (it) => Number(it.anime_id) === Number(m.id),
                      );
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      await apiClient.addReadlistItems(readlistDetailId, { anime_ids: ids });
                      setAddMangaOpen(false);
