...
const FeaturedManager = () => {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      if (selectedManga?.westanime_id) {
        createData.westanime_id = selectedManga.westanime_id;
      }
    ...
    <div className="space-y-6">
      ...
      {showAddForm && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          {/* Selected Manga */}
          {selectedManga && newItem.anime_id && (
            <div className="mb-4 p-4 bg-primary-50 dark:bg-primary-900 rounded-lg">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  {selectedManga.westanime_id && (
                    <p className="text-xs text-yellow-600 dark:text-yellow-400 mt-1">
                      (WestManga ID: {selectedManga.westanime_id || selectedManga.id})
                    </p>
                  )}
                </div>
                <button
                  onClick={() => {
                    setSelectedManga(null);
                    setNewItem(prev => ({ ...prev, anime_id: null }));
                  }}
                  className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
                  title="Hapus pilihan"
                >
