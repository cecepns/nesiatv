        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="text-center">
            <p className="text-sm font-medium text-gray-300 dark:text-gray-300">
              Copyright ©2025 Nesiatv, All Rights Reserved.
            </p>
          </div>
          ...
          <div className="text-center max-w-3xl">
            <p className="text-xs leading-relaxed text-gray-400 dark:text-gray-500">
              Semua anime di website ini hanya preview dari anime aslinya, mungkin terdapat banyak kesalahan bahasa, nama tokoh, dan alur cerita. Untuk versi aslinya, silahkan beli animenya jika tersedia di kotamu.
            </p>
          </div>
        </div>
      </div>
