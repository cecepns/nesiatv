...
async function proxy(req, res) {
  ...
  try {
    ...
    const fallbackUrl = 'https://is3.cloudhost.id/data.animeneisa/nesiatv/manga/nesiatv-update-/thumbnail-1780155400085.png';
